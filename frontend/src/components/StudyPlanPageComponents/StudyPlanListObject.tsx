...
const StudyPlanListObject: React.FC<StudyPlanListObjectProps> = ({
  ...
  return (
    <div
      className="w-full bg-zinc-800 border-2 rounded-lg py-0.5 px-1 lg:py-2 lg:px-4 cursor-pointer hover:bg-zinc-700 hover:scale-101 transition-transform duration-200 my-0.5 sm:my-1 lg:my-2"
      onClick={onClick}
    >
